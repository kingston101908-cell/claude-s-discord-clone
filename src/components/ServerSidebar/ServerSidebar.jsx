...
function ServerSidebar({ onAddServer }) {
    ...
    return (
        <nav className="server-sidebar" aria-label="Servers">
            ...
            <div className="server-sidebar-item">
                <button
                    className="server-icon home-button"
            ...
            <div className="server-list">
                {servers.map(server => (
                    <div
                        key={server.id}
                        className={`server-sidebar-item ${activeServerId === server.id ? 'active' : ''}`}
                    >
                        <button
                        ...
                        <div className={`pill-indicator ${activeServerId === server.id ? 'active' : ''}`}></div>
                    </div>
                ))}
            </div>
